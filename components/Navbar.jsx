...
import logo from '@/assets/images/swift-white-logo.png';
...
const navigation = [
  ...
  { name: 'Direct Fuel Cells', href: 'directfuelcell', current: false },
  { name: 'Renewable Fuels', href: 'renewablefuels', current: false },
